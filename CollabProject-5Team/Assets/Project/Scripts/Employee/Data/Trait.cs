...
public class TraitData
{
    ...
    public Color DisplayColor => isPositive
...
public static class TraitTable
{
    ...
    {
        // ── PLANNER ─────────────────────────────────────────
        [Trait.IdeaBank]        = T("아이디어 뱅크",  TraitRole.Planning, true,   4, TraitStat.Creativity, TraitStat.Fun),
        [Trait.IdeaDrought]     = T("아이디어 가뭄",  TraitRole.Planning, false, -3, TraitStat.Creativity, TraitStat.Fun),
        [Trait.Architect]       = T("구조 설계자",    TraitRole.Planning, true,   4, TraitStat.Precision,  TraitStat.Creativity),
        [Trait.StructureBreaker]= T("구조 붕괴자",    TraitRole.Planning, false, -3, TraitStat.Precision,  TraitStat.Creativity),
        [Trait.TrendRadar]      = T("트렌드 레이더",  TraitRole.Planning, true,   3, TraitStat.Creativity, TraitStat.Fun),
        [Trait.TrendBlind]      = T("유행 불감증",    TraitRole.Planning, false, -4, TraitStat.Creativity, TraitStat.Fun),
        [Trait.GoldenScale]     = T("황금 저울",      TraitRole.Planning, true,   3, TraitStat.Precision,  TraitStat.Fun),
        [Trait.BalanceBreaker]  = T("밸런스 폭주",    TraitRole.Planning, false, -1, TraitStat.Precision,  TraitStat.Fun),
        [Trait.NumberDetective] = T("숫자 탐정",      TraitRole.Planning, true,   1, TraitStat.Precision,  TraitStat.Fun),
        [Trait.DataIlliterate]  = T("데이터맹",       TraitRole.Planning, false, -2, TraitStat.Precision,  TraitStat.Fun),
        [Trait.OverworkArtisan] = T("과몰입 장인",   TraitRole.Planning, true,   2, TraitStat.Precision, TraitStat.Fun),
        ...
        [Trait.ErrorIgnorer]    = T("에러 방치",       TraitRole.Develop, false, -1, TraitStat.BugControl, TraitStat.Optimize),
        [Trait.NewTechLover]    = T("신기술 선호",     TraitRole.Develop, true,   1, TraitStat.TechPower,  TraitStat.Optimize),
        [Trait.OldTech]         = T("구식 기술",       TraitRole.Develop, false, -2, TraitStat.TechPower,  TraitStat.Optimize),
        [Trait.HumanDebugger]   = T("인간 디버거",    TraitRole.Develop, true,   2, TraitStat.TechPower,  TraitStat.Optimize),

        // ── ARTIST ──────────────────────────────────────────────
        [Trait.Original]        = T("독창적",         TraitRole.Art, true,   4, TraitStat.Visual,      TraitStat.Direction),
        [Trait.Copycat]         = T("카피캣",         TraitRole.Art, false, -3, TraitStat.Visual,      TraitStat.Direction),
        [Trait.HighQuality]     = T("높은 퀄리티",    TraitRole.Art, true,   4, TraitStat.Visual,      TraitStat.Composition),
        [Trait.LowQuality]      = T("낮은 퀄리티",    TraitRole.Art, false, -3, TraitStat.Visual,      TraitStat.Composition),
        [Trait.Prolific]        = T("다작형",         TraitRole.Art, true,   3, TraitStat.Composition, TraitStat.Visual),
        [Trait.SlowStarter]     = T("슬로우 스타터",  TraitRole.Art, false, -4, TraitStat.Composition, TraitStat.Visual),
        [Trait.SensoryDir]      = T("감각적 연출",     TraitRole.Art, true,   2, TraitStat.Direction,   TraitStat.Visual),
        [Trait.FlatDir]         = T("밋밋한 연출",     TraitRole.Art, false, -1, TraitStat.Direction,   TraitStat.Visual),
        [Trait.GoldenFrame]     = T("황금 구도",       TraitRole.Art, true,   1, TraitStat.Composition, TraitStat.Direction),
        [Trait.Cluttered]       = T("화면 산만",       TraitRole.Art, false, -2, TraitStat.Composition, TraitStat.Direction),

...
namespace GameDevTycoon.UI.Ingame
{
    ...
    public sealed class HRView : MonoBehaviour
    {
        ...
        [Header("Tab_EmployeeManage — Panel_EducationCourse")]
        ...
        [Header("Tab_EmployeeManage — Panel_EducationCourse — ConfirmButton Sprites")]
        [SerializeField] private Sprite _confirmActiveSprite;
        [SerializeField] private Sprite _confirmInactiveSprite;

        [Header("Tab_EmployeeManage — Panel_EducationCourse — CourseCards")]
        ...
        [Header("Tab_EmployeeManage — Panel_EducationCourse — CourseCards — SelectIMG")]
        ...
        [Header("Tab_EmployeeManage — Panel_EducationCourse — CourseCards — EducationOverlay")]
        ...
        [Header("Tab_EmployeeManage — Panel_EducationCourse — CourseCards — CostValue")]
        ...
        // Tab_EmployeeManage — Panel_EducationCourse 이벤트
    ...
    public enum HRTab { EmployeeManage, Hire }
}